<nav class="fixed left-0 top-0 z-20 w-full border-b border-gray-200 bg-white">
    <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-2">
        <a href="https://flowbite.com/" class="flex items-center">
            <img src="../logo.png" class="mr-3 h-16" alt="Voudoo Logo" />
        ...
        >
            ...
            >
                <li>
                    <a
                        href="#"
                        class="block rounded py-2 pl-3 pr-4 font-bold text-darker md:bg-transparent md:p-0"
                ...
                <li>
                    <a
                        href="#"
                        class="block rounded py-2 pl-3 pr-4 text-gray-900 hover:bg-gray-100 md:p-0"
                        >About</a
                    >
                </li>
                <li>
