...
<input type="checkbox" id="imagesModal" class="modal-toggle" />
<label for="imagesModal" class="modal">
  <label class="modal-box relative top-5" >
    ...
    <div>
        <p>All product images used originate from servers owned by <span>PRISMA PEREMARKET AS</span>,
            we have been given permission to use these images. </p>
    </div>
  </label>
</label>